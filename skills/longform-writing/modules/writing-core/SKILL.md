...
**macOS/Linux：**
```bash
bash skills/longform-writing/scripts/style_check.sh <file.md>
```

**Windows PowerShell：**
```powershell
powershell -ExecutionPolicy Bypass -File skills/longform-writing/scripts/style_check.ps1 -FilePath <file.md>
```
